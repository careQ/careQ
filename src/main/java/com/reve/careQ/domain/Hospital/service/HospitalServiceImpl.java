...
public class HospitalServiceImpl implements HospitalService{
    ...
    public RsData<Hospital> insert(String code, String name, String state, String city) {
        ...
        Hospital hospital = createHospital(code, name, state, city);

        return RsData.of("S-1", "병원테이블에 삽입되었습니다.", hospital);
    }

    private Hospital createHospital(String code, String name, String state, String city) {
    ...
    private String buildApiUrl(String id) {
        return "http://apis.data.go.kr/B552657/HsptlAsembySearchService/getHsptlBassInfoInqire" +
