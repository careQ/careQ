...
public class AdminRq {
    ...
    public AdminRq(AdminService adminService, MessageSource messageSource, LocaleResolver localeResolver, HttpServletRequest req, HttpServletResponse resp, HttpSession session) {
    ...
    public Admin getAdmin() {
        ...
        // 데이터가 없는지 체크
        if (admin == null) {
            admin = adminService.findByUsername(user.getUsername())
                    .orElseThrow(() -> {
